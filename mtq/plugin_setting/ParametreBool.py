...
class ParametreBool(Parametre):
    ...
    Le paramètre sera retourner sous forme de Bool
    ...
    def __init__(self, plugin_name:str, categorie:str, setting_name:str, default_value:bool):
        """
        Permet d'instancier un objet ParametreBool.
        ...
        Args:
            ...
            - default_value (Bool): La valeur par défautl du paramètre
        """
        Parametre.__init__(self, plugin_name, categorie, setting_name, default_value)
    
    def get(self):
        """ Permet de retourner la valeur du parmamètre en Bool"""
